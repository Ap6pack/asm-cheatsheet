  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[hsl(var(--ring))] focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        beginner:
          "border-transparent bg-[hsl(var(--beginner))] text-white shadow",
        intermediate:
          "border-transparent bg-[hsl(var(--intermediate))] text-black shadow",
        advanced:
          "border-transparent bg-[hsl(var(--advanced))] text-white shadow",
      },
    },
    defaultVariants: {
      variant: "default",
